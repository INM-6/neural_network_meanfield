#!/usr/bin/env python
'''Calculation of firing rates and rate spectra'''
...
figdir = os.path.join('microcircuit_figures', circ.param_hash)
...
ax.grid('on')
fig.savefig(os.path.join(figdir, 'microcircuit_PSD.pdf'), bbox_inches='tight')
# plt.close(fig)
...
fig.savefig(os.path.join(figdir, 'microcircuit_Re(Z(f)).pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for i in range(freqs.size, nrows*ncols):
    plt.delaxes(axes.flatten()[i])
fig.savefig(os.path.join(figdir, 'microcircuit_Im(Z(f)).pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for i in range(freqs.size, nrows*ncols):
    plt.delaxes(axes.flatten()[i])
fig.savefig(os.path.join(figdir, 'microcircuit_Z_amp(f)).pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for i in range(freqs.size, nrows*ncols):
    plt.delaxes(axes.flatten()[i])
fig.savefig(os.path.join(figdir, 'microcircuit_Z_freq(f)).pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for i in range(modes.size, nrows*ncols):
    plt.delaxes(axes.flatten()[i])
fig.savefig(os.path.join(figdir, 'microcircuit_Re(Z(f=0))_all_modes.pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for i in range(modes.size, nrows*ncols):
    plt.delaxes(axes.flatten()[i])
fig.savefig(os.path.join(figdir, 'microcircuit_Im(Z(f=0))_all_modes.pdf'), bbox_inches='tight')    
# plt.close(fig)
...
for f in freqs:
    ...
    for i in range(modes.size, nrows*ncols):
        plt.delaxes(axes.flatten()[i])
    fig.savefig(os.path.join(figdir, 'microcircuit_Z_amp(f={})_all_modes).pdf').format(f), bbox_inches='tight')    
    # plt.close(fig)
    ...
    for i in range(modes.size, nrows*ncols):
        plt.delaxes(axes.flatten()[i])
    fig.savefig(os.path.join(figdir, 'microcircuit_Z_freq(f={})_all_modes).pdf').format(f), bbox_inches='tight')    
    # plt.close(fig)
